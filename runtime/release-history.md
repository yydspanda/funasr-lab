# Historical Runtime Release Notes

Archived from the former runtime landing page. Dates, image tags and performance
figures below describe historical releases, not current deployment guarantees.
For new deployments use the [runtime guide](./readme.md).
